...
(function( $, undefined ) {
  ...
  $.widget( "ui.addresspicker", {
    ...
    _initMap: function() {
      ...
      google.maps.event.addListener(this.gmap, 'dragend', $.proxy(this._strictBounds, this));
    ...
    _strictBounds: function() {
      if (this.strictBounds.contains(this.gmap.getCenter())) return;
